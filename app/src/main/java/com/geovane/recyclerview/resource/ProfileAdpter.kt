...
class ProfileAdpter(private val onClicked: (Profile) -> Unit )
  ...
  // --------- PREPAROU o VIEWHOLDER PARA QUE ELE CONSIGA SE CONECTAR COM O LAYOUT - VIEWHOLDER...
    // ...serve para que eu controle meu xml = layout
    ...
    class ProfileViewHolder constructor(
        ...
        private val profileImage = itemView.image
            ...
            // BIND funcao que ouve tudo que a "model = profilename,linguage... esta falando" - >..
        // ..Entende o que esta dentro da VIEWHOLDER

        fun bind(profile: Profile, onClicked: (Profile) -> Unit) {// ViewHolder vai ouvir o que o profile disser
